...
require_relative '../src/default_parameter'
...
describe ClaseParaTest do
  ...
  describe "Tests de ejecución sobre herencia de clases" do
    ...
    describe 'Parámetros default' do
      it 'Puedo llamar un m_method con menos parámetros si tiene default' do
        class SomeClass
          partial_def :default, [Integer, Integer, DefaultParameter] do |x, y, z = 0|
            x + y + z
          end
        end
